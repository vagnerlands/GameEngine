...
const std::string Graphics::Window2DOGL::s_shaderName = "window";
cwc::glShader* Graphics::Window2DOGL::s_pShader = nullptr;
...
void Graphics::Window2DOGL::draw(Float dt)
{
    ...
    updateModel();
    s_pShader->setUniformMatrix4fv("model", 1, false, (GLfloat*)m_model.GetFloatPtr());
    // projection
