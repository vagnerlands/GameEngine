...
//-----------------------------------------------------------------------------
   ...
   public:
	  ...
	  bool       setTexture(const GLcharARB* varname, Graphics::ITexture* pTexture); //!< Specify value of uniform unsigned integer variable. \warning Requires GL_EXT_gpu_shader4. \param varname The name of the uniform variable.
      ...
      bool       setUniformMatrix4fv(const GLcharARB* varname, GLsizei count, GLboolean transpose, const GLfloat *value, GLint index = -1); //!< Specify values of uniform 4x4 matrix. \param varname The name of the uniform variable.
