...
// allows converting a array of bytes to istream type
...
//	vector extreme_dimensions[2];
	...
	ObjParser::list vertex_list;
	ObjParser::list vertex_normal_list;
	ObjParser::list vertex_texture_list;
	
	ObjParser::list face_list;
	ObjParser::list sphere_list;
	ObjParser::list plane_list;
	
	ObjParser::list light_point_list;
	ObjParser::list light_quad_list;
	ObjParser::list light_disc_list;
	
	ObjParser::list material_list;
